...
class SIP_Transform(ctypes.Structure):
    _fields_ = [
        ('order', ctypes.c_int),
...
class SIP_Coeffs(ctypes.Structure):
    _fields_ = [
...
dll.sip_fit_refine.argtypes = [
    ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.c_int,
    ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.c_int,
    ctypes.c_double, ctypes.c_double,
    ctypes.c_int, ctypes.c_int,
    ctypes.c_int,
    ctypes.POINTER(SIP_Transform),
    ctypes.POINTER(SIP_Coeffs),
    ctypes.POINTER(ctypes.c_double)
]
dll.sip_fit_refine.restype = ctypes.c_int
