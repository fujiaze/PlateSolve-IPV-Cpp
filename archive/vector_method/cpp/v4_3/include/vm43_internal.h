#ifndef VM43_INTERNAL_H
#define VM43_INTERNAL_H

// ============================================================================
// vm43_internal.h - V4.3 内部模块互相调用的函数声明
//
// 5 个模块的 .cpp 文件通过本头文件暴露内部函数, 互相调用
// 编译时链接为单一 DLL, 无 ctypes 边界, 无 JSON 序列化
//
// 模块组织:
//   vm43_select.cpp   - StarSelector (Phase 0)
//   vm43_match.cpp    - VectorMatcher (Phase A+B)
//   vm43_expand.cpp   - PairExpander (Phase C / IRM Step 1)
//   vm43_geometry.cpp - 局部几何一致性过滤 (IRM Step 2)
//   vm43_verify.cpp   - PairVerifier (Phase D / IRM Step 3)
//   vm43_fit.cpp      - WcsFitter (Phase E / IRM Step 4)
//   vm43_score.cpp    - S_robust 稳健评分 (IRM Step 5)
//   vm43_irm.cpp      - IRM 闭环主循环
//   vm43_entry.cpp    - vm43_solve() 入口
// ============================================================================
...
// ===========================================================================
// 内部辅助函数 (vm43_select.cpp 中实现, 供单元测试调用)
// 不在匿名命名空间, 具有外部链接; 不在 vm43_internal.h 之外的任何头文件声明
// ===========================================================================
...
// ===========================================================================
// Phase 0: StarSelector (vm43_select.cpp)
// ===========================================================================
...
// ===========================================================================
// Phase A+B: VectorMatcher (vm43_match.cpp)
// ===========================================================================
...
// ===========================================================================
// Phase C / IRM Step 1: PairExpander (vm43_expand.cpp)
// ===========================================================================
...
// ===========================================================================
// IRM Step 2: 局部几何一致性过滤 (vm43_geometry.cpp)
// ===========================================================================
...
// ===========================================================================
// Phase D / IRM Step 3: PairVerifier (vm43_verify.cpp)
// ===========================================================================
...
// ===========================================================================
// Phase E / IRM Step 4: WcsFitter (vm43_fit.cpp)
// ===========================================================================
...
// ===========================================================================
// IRM Step 5: S_robust 稳健评分 (vm43_score.cpp)
// ===========================================================================
...
int vm43_irm_refine(
    ...
    const std::vector<StarPoint>& W,
    double s0,
    double focal_length_mm,                      // 焦距 (mm, vm43_fit 需要)
    double pixel_size_um,                        // 像元尺寸 (um, vm43_fit 需要)
    double ra0, double dec0,
    int img_width, int img_height,
    double fov_diag_deg,
    const VM43SolveParams& params,
