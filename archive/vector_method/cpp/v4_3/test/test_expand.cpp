...
// 构造 CD = 单位矩阵
static v43::CDMatrix make_identity_cd() {
    v43::CDMatrix cd;
...
// 构造 CD = scalar × I
static v43::CDMatrix make_scaled_cd(double s) {
    v43::CDMatrix cd;
...
// 构造无 SIP (order=0)
static v43::SIPCoeffs make_no_sip() {
    v43::SIPCoeffs sip;
...
static v43::StarPoint make_star(double x, double y) {
    v43::StarPoint s;
    s.x = x; s.y = y; s.flux = 1.0; s.saturated = false;
    return s;
}

// 构造默认参数 (符合 vm43_types.h 中的默认值)
static v43::VM43SolveParams make_default_params() {
...
static int test_synthetic_data() {
    ...
    v43::CDMatrix cd = make_identity_cd();
    v43::SIPCoeffs sip = make_no_sip();
    ...
    v43::VM43SolveParams params = make_default_params();
    params.region_size_px = 100;  // 让网格分多个区域 (6×3=18 区)

    v43::ExpansionResult out;
    int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/1.0, /*s0=*/1.0,
                                /*ra0=*/0.0, /*dec0=*/0.0,
...
static int test_adaptive_tolerance() {
    ...
    std::vector<v43::StarPoint> U = { make_star(0.0, 0.0) };
    std::vector<v43::StarPoint> W = { make_star(5.0, 0.0), make_star(50.0, 0.0) };
    ...
    {
        v43::ExpansionResult out;
        int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/2.0, /*s0=*/1.0,
    ...
    {
        v43::ExpansionResult out;
        int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/0.5, /*s0=*/1.0,
                                    0.0, 0.0, 600, 300, params, out, nullptr);
        assert(ret == 0);
...
static int test_lowe_ratio() {
    ...
    {
        std::vector<v43::StarPoint> W = { make_star(1.0, 0.0), make_star(2.0, 0.0) };
        v43::ExpansionResult out;
        int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/10.0, /*s0=*/1.0,
                                    0.0, 0.0, 600, 300, params, out, nullptr);
        assert(ret == 0);
    ...
    {
        std::vector<v43::StarPoint> W = { make_star(1.0, 0.0), make_star(1.1, 0.0) };
        v43::ExpansionResult out;
        int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/10.0, /*s0=*/1.0,
                                    0.0, 0.0, 600, 300, params, out, nullptr);
        assert(ret == 0);
...
static int test_bidirectional_verification() {
    ...
    v43::CDMatrix cd = make_scaled_cd(10.0);  // CD = 10×I
    v43::SIPCoeffs sip = make_no_sip();
    ...
    v43::ExpansionResult out;
    int ret = v43::vm43_expand(U, W, cd, sip, /*s_robust=*/3.0, /*s0=*/1.0,
                                0.0, 0.0, 600, 300, params, out, nullptr);
    assert(ret == 0);
