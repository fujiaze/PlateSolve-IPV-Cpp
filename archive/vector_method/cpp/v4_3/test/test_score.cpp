...
//
// 注: 新版 vm43_compute_s_robust 用 median 估计平移, 残差 = 散布 (偏离中位数的程度)
...
static int test_outlier_no_pollution() {
    ...
    v43::SRobustResult out;
    int ret = v43::vm43_compute_s_robust(U, W, cps, cd, sip, TEST_S0, /*M0=*/5, out, nullptr);
    assert(ret == 0);
