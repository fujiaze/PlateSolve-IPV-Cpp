// ============================================================================
// test_irm.cpp - vm43_irm_refine 单元测试 (Task 8)
//
// 测试用例:
//   1. 空输入: C0 为空 → 返回 -1
...
static bool test_empty() {
    ...
    int rc = vm43_irm_refine(C0, CD0, U, W, 1.0, 600.0, 3.0,
...
static bool test_perfect() {
    ...
    int rc = vm43_irm_refine(C0, CD0, U, W, s0, 600.0, 3.0,
...
int main() {
    printf("================================\n");
    printf("vm43_irm_refine 单元测试 (Task 8)\n");
    printf("================================\n\n");
    ...
    run(v43::test_empty);
    run(v43::test_perfect);
    run(v43::test_with_noise);
