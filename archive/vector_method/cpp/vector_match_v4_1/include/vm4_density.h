#ifndef VM4_1_DENSITY_H
#define VM4_1_DENSITY_H
...
// V4.1 不对称密度匹配：Gaia侧密度 = gaia_density_ratio × 图像侧密度
// 与V4.0的density_match_query区别：
//   1. 查询半径 = fov_diag_deg × gaia_query_radius_factor（V4.0是0.5×query_radius_factor）
//   2. 目标星数 = gaia_density_ratio × n_img × (查询圆面积/图像面积)（V4.0是k_match × n_img）
//   3. 迭代步长自适应：前4次0.5，后续0.25（V4.0固定0.5）
