...
//
// 测试 vm44_match.cpp 中的主函数 v44::vm44_match:
...
//   - 参数: VM44SolveParams 替代 VectorMatcherParams
//   - 调用: v44::vm44_match(...) 替代 vm_match(...)
//
// 编译: make test_match
...
// ============================================================================
// 构建 VM44SolveParams (仅设置 VectorMatcher 相关字段)
// ============================================================================
...
static void test_synthetic_match()
{
    ...
    int ret = v44::vm44_match(U, W, /*s0=*/1.0, params, output, /*logger=*/nullptr);

    printf("  vm44_match 返回: %d, success=%d\n", ret, (int)output.success);
    ...
    ASSERT_TRUE(ret == 0, "vm44_match 返回成功 (ret == 0)");
...
static void test_different_seed()
{
    ...
    // 重新生成数据 (相同变换, 不同分布)
    std::vector<v44::StarPoint> U2, W2;
    int N2, M2;
    double s_true = 1.0;
    ...
    v44::VectorMatchResult output2;
    int ret2 = v44::vm44_match(U2, W2, /*s0=*/1.0, params, output2, nullptr);
    ...
    ASSERT_TRUE(ret2 == 0, "Test2 vm44_match 返回成功");
...
static void test_prosac_disabled()
{
    ...
    std::vector<v44::StarPoint> U3, W3;
    int N3, M3;
    double s_true = 1.0;
    double theta_true = -90.0 * DEGTORAD;
    ...
    v44::VectorMatchResult output3;
    int ret3 = v44::vm44_match(U3, W3, /*s0=*/1.0, params, output3, nullptr);
    ...
    ASSERT_TRUE(ret3 == 0, "Test3 vm44_match 返回成功");
...
static void test_invalid_input()
{
    ...
    // 空 U 数组
    {
        std::vector<v44::StarPoint> empty_U;
        ...
        v44::VectorMatchResult output;
        int ret = v44::vm44_match(empty_U, W, 1.0, params, output, nullptr);
    ...
    // 空 W 数组
    {
        ...
        std::vector<v44::StarPoint> empty_W;
        v44::VectorMatchResult output;
        int ret = v44::vm44_match(U, empty_W, 1.0, params, output, nullptr);
