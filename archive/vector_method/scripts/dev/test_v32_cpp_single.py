...
from vector_match_v3_2_cpp import VectorMatch
...
def test_frame(fits_path, gaia_dir):
    ...
    vm = VectorMatch(gaia_dir, db_type=1)
...
if __name__ == "__main__":
    ...
    if args.frame in ("t2", "both"):
        print("=" * 60)
        print("T2 Frame Test (V3.2 C++ - SNR Dynamic Tightening)")
        print("=" * 60)
    ...
    if args.frame in ("t4", "both"):
        print("=" * 60)
        print("T4 Frame Test (V3.2 C++ - SNR Dynamic Tightening)")
        print("=" * 60)
