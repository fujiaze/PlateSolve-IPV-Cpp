...
from vector_match_v3_3_cpp import VectorMatch
...
if __name__ == "__main__":
    ...
    if args.frame in ("t2", "both"):
        print("=" * 60)
        print("T2 Frame Test (V3.3 C++ Record-and-Refine)")
        print("=" * 60)
    ...
    if args.frame in ("t4", "both"):
        print("=" * 60)
        print("T4 Frame Test (V3.3 C++ Record-and-Refine)")
        print("=" * 60)
